...
var app = (function () {
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			attr_dev(li, "class", "svelte-1pmaeuf");
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h2 = element("h2");
    			if (default_slot_or_fallback) default_slot_or_fallback.c();
    			attr_dev(ul, "class", "stars svelte-1pmaeuf");
    			add_location(ul, file$4, 9, 2, 190);
    			add_location(span, file$4, 18, 4, 346);
    			attr_dev(h2, "class", "svelte-1pmaeuf");
    			add_location(h2, file$4, 19, 4, 402);
    			attr_dev(div0, "class", "text svelte-1pmaeuf");
    			add_location(div0, file$4, 17, 2, 322);
    			attr_dev(div1, "class", "rating svelte-1pmaeuf");
    		...
    		m: function mount(target, anchor) {
    			...
    			if (default_slot_or_fallback) {
    				default_slot_or_fallback.m(h2, null);
    			}
    ...
    const get_user_slot_changes = dirty => ({});
    const get_user_slot_context = ctx => ({});
    ...
    function create_fragment$6(ctx) {
    	...
    	let blockquote;
    	let current;
    	const user_slot_template = /*#slots*/ ctx[2].user;
    	const user_slot = create_slot(user_slot_template, ctx, /*$$scope*/ ctx[1], get_user_slot_context);
    	const user_slot_or_fallback = user_slot || fallback_block_1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			h3 = element("h3");
    			if (user_slot_or_fallback) user_slot_or_fallback.c();
    			t1 = space();
    			h4 = element("h4");
    			...
    			attr_dev(img, "class", "svelte-1dma1g6");
    			add_location(img, file$5, 5, 2, 102);
    			attr_dev(h3, "class", "name svelte-1dma1g6");
    			add_location(h3, file$5, 7, 4, 189);
    			attr_dev(h4, "class", "svelte-1dma1g6");
    			add_location(h4, file$5, 10, 4, 270);
    			attr_dev(div0, "class", "title svelte-1dma1g6");
    			add_location(div0, file$5, 6, 2, 164);
    			attr_dev(blockquote, "class", "svelte-1dma1g6");
    			add_location(blockquote, file$5, 13, 2, 309);
    			attr_dev(div1, "class", "card svelte-1dma1g6");
    		...
    		m: function mount(target, anchor) {
    			...
    			if (user_slot_or_fallback) {
    				user_slot_or_fallback.m(h3, null);
    			}
    			...
    			if (default_slot_or_fallback) {
    				default_slot_or_fallback.m(blockquote, null);
    			}
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (user_slot) {
    				if (user_slot.p && dirty & /*$$scope*/ 2) {
    					update_slot(user_slot, user_slot_template, ctx, /*$$scope*/ ctx[1], dirty, get_user_slot_changes, get_user_slot_context);
    				}
    			}
    		...
    		i: function intro(local) {
    			if (current) return;
    			transition_in(user_slot_or_fallback, local);
    			transition_in(default_slot_or_fallback, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(user_slot_or_fallback, local);
    			transition_out(default_slot_or_fallback, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div1);
    			if (user_slot_or_fallback) user_slot_or_fallback.d(detaching);
    			if (default_slot_or_fallback) default_slot_or_fallback.d(detaching);
    		}
    	};
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("Card", slots, ['user','default']);
    ...
    // (23:6) <span slot="user">
    function create_user_slot_2(ctx) {
    	let span;

    	const block = {
    		c: function create() {
    			span = element("span");
    			span.textContent = "Brent Sux";
    			attr_dev(span, "slot", "user");
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		block,
    		id: create_user_slot_2.name,
    		type: "slot",
    		source: "(23:6) <span slot=\\\"user\\\">",
    		ctx
    	});
    ...
    // (29:6) <span slot="user">
    function create_user_slot_1(ctx) {
    	let span;

    	const block = {
    		c: function create() {
    			span = element("span");
    			span.textContent = "Kyle Wads";
    			attr_dev(span, "slot", "user");
    			add_location(span, file$6, 28, 6, 901);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		block,
    		id: create_user_slot_1.name,
    		type: "slot",
    		source: "(29:6) <span slot=\\\"user\\\">",
    		ctx
    	});
    ...
    // (34:6) <span slot="user">
    function create_user_slot(ctx) {
    	let span;

    	const block = {
    		c: function create() {
    			span = element("span");
    			span.textContent = "PB Powell";
    			attr_dev(span, "slot", "user");
    			add_location(span, file$6, 33, 6, 1127);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		block,
    		id: create_user_slot.name,
    		type: "slot",
    		source: "(34:6) <span slot=\\\"user\\\">",
    		ctx
    	});
    ...
    // (33:4) <Card avatar="https://unsplash.it/50?random=3">
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(33:4) <Card avatar=\\\"https://unsplash.it/50?random=3\\\">",
    		ctx
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1wv75yz");
    			add_location(h1, file$6, 7, 4, 132);
    			add_location(p, file$6, 8, 4, 185);
    			attr_dev(section0, "class", "header svelte-1wv75yz");
    			add_location(section0, file$6, 6, 2, 103);
    			attr_dev(section1, "class", "ratings svelte-1wv75yz");
    			add_location(section1, file$6, 14, 2, 438);
    			attr_dev(section2, "class", "reviews svelte-1wv75yz");
    			add_location(section2, file$6, 20, 2, 612);
    			attr_dev(main, "class", "svelte-1wv75yz");
